...
let options: any = {
  ...
  channel: '83d49dcc-0b55-431e-8863-801468d24640',
  // Pass your temp token here.
  token: '0061ba2592b16b74f3497e232e1b01f66b0IABl/i6cmbQi5KACk283qU9U9uT5oA+nQPtzilYhvVL1XjAG7FZjNTGuIgBM+IrP/KvAZAQAAQCEYb9kAgCEYb9kAwCEYb9kBACEYb9k',
  // Set the user ID.
  uid: 78052,
  // Set the user role
  role: ''
...
@Component({
  selector: 'app-testinglive',
  templateUrl: './testinglive.component.html',
  styleUrls: ['./testinglive.component.css']
})

export class TestingliveComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //     audio: false // No need to capture audio for screen sharing
    //   });
    // } catch (err) {
  ...
  async startBasicCall() {
    ...
    const localPlayerContainer: any = document.createElement('div');
